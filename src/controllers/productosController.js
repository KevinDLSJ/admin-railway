...
//Redirige a la pagina de "/productos"
  ...
  function buscar(req, res){
    ...
    console.log(busc)
    req.getConnection((err, conn)=>{
      conn.query("SELECT a.costo, a.unidad_medida, a.id_producto, a.name, b.descripcion, a.precio, c.description FROM product a, articulo b, units c WHERE a.tipo_art=b.tipo_art and a.unidad_medida=c.unidad_medida and a.name LIKE ? ORDER BY `name` ASC ", [busc], (err, pers) => {
